...
#include "RammsSportsCar.h"
#include "RammsSportsWheelFront.h"
#include "RammsSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARammsSportsCar::ARammsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URammsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URammsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URammsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URammsSportsWheelRear::StaticClass();
