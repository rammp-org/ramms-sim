...
ARammsOffroadCar::ARammsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URammsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URammsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URammsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URammsOffroadWheelRear::StaticClass();
